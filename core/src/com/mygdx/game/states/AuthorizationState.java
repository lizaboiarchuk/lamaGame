...
public class AuthorizationState extends State {
  ...
  //  private Stage stage;
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(registrationButton, StartClass.WIDTH/2-loginButton.getWidth()/2, StartClass.HEIGHT/2-160);
        ...
        loginFont.draw(sb, "Sign up", StartClass.WIDTH/2-42, StartClass.HEIGHT/2-120);
